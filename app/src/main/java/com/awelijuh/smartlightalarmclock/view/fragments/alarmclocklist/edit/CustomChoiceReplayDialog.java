...
public class CustomChoiceReplayDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        Set<DayOfWeek> period = alarmEditViewModel.period.getValue();
        ...
        builder.setPositiveButton(R.string.ok_text, (dialogInterface, i) -> {
            ...
            alarmEditViewModel.period.setValue(week.stream().filter(e -> selected[week.indexOf(e)]).collect(Collectors.toSet()));
